...
// ID de la planilla
$spreadsheetId = "1_BwoLTeOP24gIEqASo-Z3US2AE-12_trkaFULCXKBKs"; 
$range = "Instituciones v2"; // el nombre exacto de la pestaña
...
try {
    ...
    if (empty($values)) {
        echo json_encode([
            "status" => "error",
            "message" => "No se encontraron datos en el rango/pestaña especificado"
